    ...
    return (
        <div className="md:flex justify-between items-center mx-auto mb-24">
            <div className="text-center md:text-left md:w-3/5 md:ml-4">
                ...
                <h3 className="text-2xl mb-4 md:text-3xl xl:text-5xl">Empowering Miami's Youth in Climate Action</h3>
                ...
                <button className="py-2 px-3 rounded-lg border">Get Started</button>
            </div>
