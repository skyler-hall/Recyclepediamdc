...
const NewsletterBanner = () => {
    return(
        <div className="bg-[#234E13] rounded-3xl shadow-2xl sm:flex items-center w-screen relative left-[calc(-50vw+50%)] xl:left-0 py-8 my-40 2xl:mt-20 max-w-7xl">
            <div className="sm:w-4/12 mb-6 sm:mb-0">
                <img src='Diggy.png' className=" scale-110 md:scale-125"/>
            </div>
